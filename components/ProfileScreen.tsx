...
import { Edit2, Ruler, Weight, Calendar, User as UserIcon, Activity } from 'lucide-react';
...
export const ProfileScreen: React.FC<ProfileScreenProps> = ({ user, currentWeight }) => {
    ...
    <div className="flex flex-col gap-5 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-white rounded-3xl p-6 shadow-sm border border-primary/5 flex flex-col items-center relative overflow-hidden">
        ...
        <div className="relative">
            ...
            <button className="absolute bottom-0 right-0 bg-primary text-white p-2 rounded-full shadow-sm hover:bg-blue-700 transition-colors">
                <Edit2 size={14} />
            </button>
        </div>
